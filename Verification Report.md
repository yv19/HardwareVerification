...
Opening the file `gpio_test_score.txt` inside the output directory shows the following output:
...
![Screenshot_Jasper](./Images/VGA_formal.png)
...
![Screenshot_Jasper](./Images/VGA_DLS.png)
...
![Unit_level](./Images/VGA_unit.png)

- An example of the monitor output for one of the tests (Full Frame) is shown below

![Full_Frame](./Images/VGA_full_frame.png)

- Functional Coverage bins were created to test how well the tests were covering the different functionalities of the GPIO. These bins are as follows:

    1. Invalid Inputs
    2. Character fills in each X and Y position on the screen
    3. Diffierent types of characters
    4. A mix of both
    5. Different control signals

The functional coverage report is shown below:

![Screenshot_functional](./Images/VGA_fun_cov.png)

- The code coverage is also generated by QuestaSim in order to test how much of the peripheral is hit throughout the tests.

The code coverage report is shown below:

![Screenshot_code](./Images/VGA_code_cov.png)
