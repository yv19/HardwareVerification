...
bind AHBGPIO AHBGPIO_assertions u_AHBGPIO_assertions (
    .HCLK(ahbgpio_if.HCLK), 
    .HRESETn(ahbgpio_if.HRESETn), 
    .HADDR(ahbgpio_if.HADDR), 
    .HWDATA(ahbgpio_if.HWDATA), 
    .HREADY(ahbgpio_if.HREADY), 
    .HWRITE(ahbgpio_if.HWRITE), 
    .HTRANS(ahbgpio_if.HTRANS), 
    .HSEL(ahbgpio_if.HSEL), 
    .HREADYOUT(ahbgpio_if.HREADYOUT),
    .HRDATA(ahbgpio_if.HRDATA),

    .GPIOIN(ahbgpio_if.GPIOIN),
    .PARITYSEL(ahbgpio_if.PARITYSEL),
    .GPIOOUT(ahbgpio_if.GPIOOUT),
    .PARITYERR(ahbgpio_if.PARITYERR)
    );
